...
function pregunta(dato) --El dato siempre debe ser string
  io.write('\n', "Ingrese ",  dato, ": ")
  input = io.read()
  return error_checker_num(input)
end
...
repeat
    ...
    notaapro = pregunta("nota minima de aprovacion (Generalmente 4.0)")
    
    exigencia = pregunta("porcentaje de exigencia sin el simbolo(por ejemplo 60% = 60)")/100
...
until(repetir == negar[1] or repetir == negar[2] or repetir == negar[3] or repetir == negar[4] or repetir == negar[5])
